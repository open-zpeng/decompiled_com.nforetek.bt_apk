...
public interface INfCallbackGattServer extends IInterface {
    ...
    /* loaded from: classes.dex */
    public static class Default implements INfCallbackGattServer {
        @Override // com.nforetek.bt.aidl.INfCallbackGattServer
    ...
    /* loaded from: classes.dex */
    public static abstract class Stub extends Binder implements INfCallbackGattServer {
        private static final String DESCRIPTOR = "com.nforetek.bt.aidl.INfCallbackGattServer";
        ...
        public static INfCallbackGattServer asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof INfCallbackGattServer)) {
                return (INfCallbackGattServer) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    onGattServerServiceAdded(_arg02, _arg12, _arg22);
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onGattServerServiceDeleted(_arg03, _arg13, _arg2);
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onGattServerCharacteristicReadRequest(_arg04, _arg14, _arg23, _arg3, _arg4, _arg52, _arg64);
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onGattServerCharacteristicWriteRequest(_arg05, _arg15, _arg24, _arg32, _arg42, _arg53, _arg63, _arg73, _arg82);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onGattServerDescriptorReadRequest(_arg06, _arg16, _arg25, _arg33, _arg43, _arg5, _arg62, _arg72);
                    reply.writeNoException();
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onGattServerDescriptorWriteRequest(_arg07, _arg17, _arg26, _arg34, _arg44, _arg54, _arg6, _arg7, _arg8, _arg9);
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
        ...
        /* loaded from: classes.dex */
        public static class Proxy implements INfCallbackGattServer {
            public static INfCallbackGattServer sDefaultImpl;
        ...
        public static boolean setDefaultImpl(INfCallbackGattServer impl) {
        ...
        public static INfCallbackGattServer getDefaultImpl() {

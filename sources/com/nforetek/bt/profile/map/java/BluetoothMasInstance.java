...
public final class BluetoothMasInstance implements Parcelable {
    public static final Parcelable.Creator<BluetoothMasInstance> CREATOR = new Parcelable.Creator<BluetoothMasInstance>() { // from class: com.nforetek.bt.profile.map.java.BluetoothMasInstance.1
    ...
    public String toString() {
        return String.valueOf(Integer.toString(this.mId)) + ":" + this.mName + ":" + this.mChannel + ":" + Integer.toHexString(this.mMsgTypes);
    }

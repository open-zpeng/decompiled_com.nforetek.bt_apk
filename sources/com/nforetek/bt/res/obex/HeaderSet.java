...
public final class HeaderSet {
    ...
    private static final String TAG = "HeaderSet";
    ...
    public void setHeader(int headerID, Object headerValue) {
        NfLog.d(false, TAG, "headerID " + headerID);
        NfLog.d(false, TAG, "headerValue " + headerValue);
        switch (headerID) {
            case 1:
            ...
            default:
                if (headerID >= 48 && headerID <= 63) {
                    ...
                    return;
                } else if (headerID >= 240 && headerID <= 255) {
                    if (!(headerValue instanceof Long)) {
                        if (headerValue == null) {
    ...
    public int[] getHeaderList() throws IOException {
        ...
        for (int i2 = NfDef.STATE_BASIC_CONNECT_CHECKING_NEED_DISCONNECT_PROFILE; i2 < 128; i2++) {
        ...
        for (int i5 = 0; i5 < headers.length; i5++) {
            result[i5] = headers[i5] & NfDef.AVRCP_PLAYING_STATUS_ID_ERROR;
        }
        return result;
    }

...
public class NfDef {
    public static final String ACTION_EXTEND_LOCAL_OOB_DATA = "android.bluetooth.adapter.action.EXTEND_LOCAL_OOB_DATA";
    ...
    public static final int AUTO_CONNECT_MAX_VALUE = 7;
    ...
    public static final String EXTRA_LOCAL_OOB_DATA_KEY_C = "android.bluetooth.adapter.extra.LOCAL_OOB_DATA_KEY_C";
    public static final String EXTRA_LOCAL_OOB_DATA_KEY_C192 = "android.bluetooth.adapter.extra.LOCAL_OOB_DATA_KEY_C192";
    public static final String EXTRA_LOCAL_OOB_DATA_KEY_C256 = "android.bluetooth.adapter.extra.LOCAL_OOB_DATA_KEY_C256";
    public static final String EXTRA_LOCAL_OOB_DATA_KEY_R = "android.bluetooth.adapter.extra.LOCAL_OOB_DATA_KEY_R";
    public static final String EXTRA_LOCAL_OOB_DATA_KEY_R192 = "android.bluetooth.adapter.extra.LOCAL_OOB_DATA_KEY_R192";
    public static final String EXTRA_LOCAL_OOB_DATA_KEY_R256 = "android.bluetooth.adapter.extra.LOCAL_OOB_DATA_KEY_R256";
    ...
    public static final int STATE_BASIC_CONNECT_BEGIN = 111;
    public static final int STATE_BASIC_CONNECT_CHECKING_NEED_DISCONNECT_PROFILE = 112;
    public static final int STATE_BASIC_CONNECT_CHECKING_SECOND_CONNECT = 130;
    public static final int STATE_BASIC_CONNECT_CONNECTING_A2DP = 122;
    public static final int STATE_BASIC_CONNECT_CONNECTING_AVRCP = 123;
    public static final int STATE_BASIC_CONNECT_CONNECTING_HFP = 121;
    public static final int STATE_BASIC_CONNECT_DISCONNECTING_PROFILE = 113;
    public static final int STATE_BASIC_CONNECT_FINISHED = 140;
    public static final int STATE_BASIC_CONNECT_INITIALIZING = 110;
    public static final int STATE_BASIC_CONNECT_SECOND_CONNECTING_A2DP = 132;
    public static final int STATE_BASIC_CONNECT_SECOND_CONNECTING_AVRCP = 133;
    public static final int STATE_BASIC_CONNECT_SECOND_CONNECTING_HFP = 131;
    public static final int STATE_BASIC_CONNECT_WAITING_BEFORE_CONNECT_PROFILE = 120;
    public static final int STATE_BASIC_CONNECT_WAITING_FOR_PROFILE_DISCONNECTED = 114;

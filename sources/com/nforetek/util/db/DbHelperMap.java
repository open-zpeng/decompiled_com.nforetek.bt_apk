...
public class DbHelperMap extends SQLiteOpenHelper {
    ...
    public void deleteMessageByFolderAndHandle(SQLiteDatabase db, int folder, String handle, String address) {
        db.execSQL("delete from MessageContent where folder = ? and handle = ? and macAddress = ?", new String[]{new StringBuilder().append(folder).toString(), handle, address});
    }
}
